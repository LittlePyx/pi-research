...
export function ResearchWorkbook({ spaceId, trackId, locale, onOpenPaper, onBack, taskContext }: {
  ...
  return <main className="pi-workbook">
    ...
    {content && <>
      ...
      <SectionNavigation label={zh ? "本次比较" : "This comparison"} items={[{ label: zh ? "查看比较内容" : "Comparison", target: ".pi-workbook-layout" }, { label: zh ? "证据与核查" : "Evidence & checks", target: ".pi-workbook-inspector" }, { label: zh ? "记录我的判断" : "My judgment", target: ".pi-workbook-artifact" }]} />
