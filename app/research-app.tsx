          ...
          <main className="v2-page v2-today pi-editorial-today">
            ...
            {monitor?.dailyBrief && (dailyBriefEntryCount > 0 || !additionalTodayPapers.length) && <section className={`v2-ai-daily-brief ${monitor.dailyBrief.status}`}>
              <div className="v2-daily-brief-lead">
                <header><div><p className="v2-kicker">{monitor.dailyBrief.date}</p><h2>{monitor.dailyBrief.isCurrent ? (locale === "zh" ? "今日研究简报" : "Today’s research brief") : (locale === "zh" ? "最近研究简报" : "Latest research brief")}</h2></div><span>{dailyBriefEntryCount} {locale === "zh" ? "篇入选" : "selected"}</span></header>
