    ...
    <div className="v2-app">
      <aside className={"v2-sidebar " + (mobileNav ? "open" : "")}>
        ...
        <div className="v2-sidebar-bottom">
          <Link className="v2-demo-entry" href="/demo"><span>◌</span><strong>{locale === "zh" ? "演示空间" : "Demo workspace"}</strong><b>↗</b></Link>
          ...
          <main className="v2-page v2-today">
            ...
            {monitor?.dailyBrief && <section className={`v2-ai-daily-brief ${monitor.dailyBrief.status}`}>
              ...
              <div className="v2-daily-paper-queue">
                <header><div><strong>{monitor.dailyBrief.isCurrent ? (locale === "zh" ? "今日阅读队列" : "Today's reading queue") : (locale === "zh" ? `${monitor.dailyBrief.date} 阅读队列` : `${monitor.dailyBrief.date} reading queue`)}</strong><small>{locale === "zh" ? "按优先级排序" : "Ordered by priority"}</small></div><span>{dailyBriefEntryCount} {locale === "zh" ? "篇" : "papers"}</span></header>
