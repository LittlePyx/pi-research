...
export async function handleServerPilot(request,{database,apiKey,experiment,accessHash,expiresAt,fetchImpl=fetch,now=Date.now()}) {
 ...
 const record=await executePilotRun(experiment,task,body.variant,{apiKey,sourceCommit:body.sourceCommit,executionSourceCommit:body.executionSourceCommit||body.sourceCommit,fetchImpl});
