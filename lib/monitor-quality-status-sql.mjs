...
export function qualityQueueCountsSql(activeRoutePredicate) {
  return `WITH candidates AS (
    SELECT i.analysis_source, i.verification_status,
   ...
   COALESCE(SUM(eligible = 1 AND analysis_source = 'deepseek_rejected' AND verification_status = 'degraded' AND needs_abstract = 0), 0) AS retryCount,
